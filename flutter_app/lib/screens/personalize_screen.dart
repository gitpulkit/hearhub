                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Switch(value: _highContrast, onChanged: (v) => setState(() => _highContrast = v), activeThumbColor: AppColors.primary),
                            ],
                          ),
                        ],
                      ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Switch(value: _reducedMotion, onChanged: (v) => setState(() => _reducedMotion = v), activeThumbColor: AppColors.primary),
                            ],
                          ),
                          const Divider(color: AppColors.border),
                          Row(
                            ...
                            children: [
                              ...
                              Switch(value: _tactileFeedback, onChanged: (v) => setState(() => _tactileFeedback = v), activeThumbColor: AppColors.primary),
                            ],
                          ),
                        ],
                      ),
